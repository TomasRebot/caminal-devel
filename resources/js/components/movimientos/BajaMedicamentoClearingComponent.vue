...
<div class="row" id="baja-medicamento-clearing">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Entrega de medicamentos por clearing<small></small></h2>
      ...
      <div class="x_content"> <!-- Smart Wizard -->        
        ...
        <div id="wizard" class="form_wizard wizard_horizontal">
          ...
          <div class="actionBar">
            <a class="buttonFinish btn btn-default" :class="{'buttonDisabled': deshabilitar_confirmar_btn}" @click="confirmarEntrega">
              Confirmar
            </a>
