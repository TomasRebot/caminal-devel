					...
					<table class="table table-striped jambo_table bulk_action">
						...
						<tbody>
							<tr class="even pointer" v-for="(institucion , key) in getLista" :key="key">						
								...
								<td class="last" @click="seleccionarInstitucion(institucion)"><a> {{institucion.direccion}} </a></td>
                            </tr>
						</tbody>
...
export default {
    ...
    mounted(){
        ...
        this.form = [
            {'nombre' : 'moreira', 'direccion': 'coliqueo' },
                {'nombre' : 'rebot', 'direccion': 'suipacha' }
            ];
    ...
    methods: {
        seleccionarInstitucion: function( insitucion ){
            this.$emit('institucion-seleccionada' , insitucion);
        },
